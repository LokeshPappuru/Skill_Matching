...
st.set_page_config(page_title="Skill Matcher", layout="wide", page_icon="https://cdn.icon-icons.com/icons2/2699/PNG/512/hitachi_logo_icon_168125.png")
...
if "master_skill_file" not in st.session_state:
    st.session_state.master_skill_file = None
            ...
            if "Skill" not in subcon_df.columns:
                ...
                if filtered_combined_display.empty:
                    ...
                    st.download_button(
                        ...
                        data=excel_data,
                        file_name='combined_bench_subcon_match.xlsx',
                        mime='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'
                    )
...
st.markdown("""
    <style>
        /* Remove default padding/margin around the main content */
        ...
        /* Optional: remove header and footer spacing */
...
st.markdown(
    """
    <h1 style='color:#272727; margin:0px; padding:0px;'>
        RMG Skill Matcher
    </h1>
    <br>
...
if not st.session_state.uploaded:
    st.markdown(
    """
    <h3 style='color:#272727; margin:0px; padding:0px;'>
